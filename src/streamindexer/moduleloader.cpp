...
void ModuleLoader::getThroughAnalyzers(std::list<ThroughPair>* analyzers){
	std::list<Module*>::iterator mod_itr = modules.begin();
	while ( mod_itr != modules.end() ){
	   Module* mod = *mod_itr;
...
void ModuleLoader::deleteThroughAnalyzers(std::list<ThroughPair>* analyzers){
...
void ModuleLoader::deleteEndAnalyzers(std::list<EndPair>* analyzers){
...
bool ModuleLoader::Module::init(){
	#ifdef HAVE_DLFCN_H
	createThroughFunc = (createThroughAnalyzer*)dlsym(handle, "createThroughAnalyzer");
    createEndFunc = (createEndAnalyzer*)dlsym(handle, "createEndAnalyzer");
    deleteFunc = (deleteAnalyzer*)dlsym(handle, "deleteAnalyzer");
    #else
